    ...
    <div style={styles.body}>
        ...
        <div style={styles.hero}>
          <div style={styles.heroContent}>
            ...
            <div className="hero-enter hero-enter--delay-4" style={styles.heroButtons}>
              <button type="button" onClick={() => handleProtectedAction('/donate')} className="hero-btn-primary" style={{ ...styles.btn, backgroundColor: '#ffffff', color: '#1E4D4B', border: 'none', boxShadow: '0 4px 14px rgba(255, 255, 255, 0.15)', display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px' }}>
                <i className="fa-solid fa-hand-holding-heart"></i> Start Donating
              </button>
              <button type="button" onClick={() => handleProtectedAction('/marketplace')} className="hero-btn-secondary" style={{ ...styles.btn, backgroundColor: 'transparent', color: '#ffffff', border: '2px solid rgba(255, 255, 255, 0.4)', display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px' }}>
      ...
      <section id="marketplace" style={styles.categories}>
        ...
        <div className="reveal-stagger" style={styles.categoryGrid}>
          <div className="card-hover-lift" style={styles.categoryCard} onClick={() => navigate('/marketplace')}>
            ...
            <div style={styles.bundleDetails}>
              ...
              <div style={styles.bundlePriceRow}>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <button type="button" onClick={() => navigate('/cart')} style={{ ...styles.btn, ...styles.btnPrimary, ...styles.btnSm }}>Add to Cart</button>
                  <button type="button" onClick={() => navigate('/marketplace')} style={{ ...styles.btn, ...styles.btnSecondary, ...styles.btnSm }}>Wishlist</button>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Home page does not render AuthModal directly; Navbar handles auth modal */}
