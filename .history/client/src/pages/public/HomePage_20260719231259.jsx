        ...
        <div style={styles.hero}>
          <div style={styles.heroContent}>
            ...
            <div className="hero-enter hero-enter--delay-4" style={styles.heroButtons}>
              ...
              <Link to="/marketplace" className="hero-btn-secondary" style={{ ...styles.btn, backgroundColor: 'transparent', color: '#ffffff', border: '2px solid rgba(255, 255, 255, 0.4)', display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px' }}>
