        ...
        <div style={styles.hero}>
          <div style={styles.heroContent}>
            ...
            <div className="hero-enter hero-enter--delay-4" style={styles.heroButtons}>
              <Link to="/donate" className="hero-btn-primary" style={{ ...styles.btn, backgroundColor: '#ffffff', color: '#1E4D4B', border: 'none', boxShadow: '0 4px 14px rgba(255, 255, 255, 0.15)', display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px' }}>
                <i className="fa-solid fa-hand-holding-heart"></i> Start Donating
              </Link>
              <Link to="/login?redirect=/marketplace" className="hero-btn-secondary" style={{ ...styles.btn, backgroundColor: 'transparent', color: '#ffffff', border: '2px solid rgba(255, 255, 255, 0.4)', display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px' }}>
