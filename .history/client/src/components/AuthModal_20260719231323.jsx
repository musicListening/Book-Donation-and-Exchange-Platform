...
export default function AuthModal({ isOpen, onClose, initialMode = 'login', redirectTo = null }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // If a redirect target was provided (e.g. user clicked Donate / Marketplace), go there.
      if (redirectTo) {
        navigate(redirectTo);
        return;
      }
