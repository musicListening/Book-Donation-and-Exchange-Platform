...
const c = { primary: '#176b63', dark: '#0f4e48', soft: '#e2f1ee', surface: '#fff', canvas: '#f5f8f7', ink: '#172b29', muted: '#5c6a68', border: '#d6e2df', error: '#b74f47' };
    ...
    <div className="community-page">
      ...
      <style>{`
        *{box-sizing:border-box}
        .community-page{min-height:100vh;background:${c.canvas};color:${c.ink};font-family:'DM Sans',sans-serif}
        button{font:inherit}
        h1,h2{font-family:'Libre Baskerville',serif;letter-spacing:0}
        .nav{position:sticky;top:0;z-index:10;background:${c.surface};border-bottom:1px solid ${c.border}}
        ...
        .content{max-width:1200px;margin:auto;padding:44px 24px 72px}
        ...
        .count{border:1px solid ${c.border};background:#fff;border-radius:99px;padding:8px 13px;color:${c.muted};font-size:14px;white-space:nowrap}
        .primary-button{display:flex;align-items:center;gap:8px;border:0;border-radius:6px;background:${c.primary};color:#fff;padding:10px 16px;font-weight:700;cursor:pointer}
        .event-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px}
        .event-card{background:#fff;border:1px solid ${c.border};border-radius:8px;overflow:hidden;cursor:pointer;transition:transform .2s,box-shadow .2s;position:relative}
        ...
        .label{display:inline-block;background:${c.soft};color:${c.dark};border-radius:99px;padding:5px 9px;font-size:12px;font-weight:700}
        ...
        .empty{border:1px dashed ${c.border};background:#fff;padding:56px 24px;text-align:center;color:${c.muted};border-radius:8px;grid-column:1/-1}
        .empty h2{color:${c.ink};font-size:20px;margin:12px 0 6px}
        .error{color:${c.error}}
        .details,.conversation{max-width:900px;margin:auto;background:#fff;border:1px solid ${c.border};border-radius:8px;overflow:hidden}
        ...
        .detail-meta>div{padding:16px;background:${c.canvas};border-radius:6px;display:flex;gap:11px;color:${c.primary}}
        ...
        .message-list{min-height:390px;max-height:56vh;overflow:auto;padding:24px;background:#fbfdfc}
        ...
        .composer{padding:16px 20px;display:flex;gap:12px;border-top:1px solid ${c.border}}
        .composer textarea{flex:1;resize:vertical;min-height:48px;max-height:110px;padding:12px;border:1px solid ${c.border};border-radius:6px;color:${c.ink};font:inherit}
        .composer textarea:focus{outline:2px solid ${c.soft};border-color:${c.primary}}
        .send{width:48px;height:48px;align-self:end;border:0;border-radius:6px;background:${c.primary};color:#fff;display:grid;place-items:center;cursor:pointer}
        ...
        .modal{position:relative;width:min(100%,600px);max-height:calc(100vh - 40px);overflow:auto;background:#fff;border-radius:8px;padding:26px;box-shadow:0 24px 60px rgba(0,0,0,.2)}
